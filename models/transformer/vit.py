...
from models.transformer.helpers import _create_vision_transformer, trunc_normal_, _init_vit_weights, named_apply, _load_weights
...
def vit_base_patch16_224(pretrained=False, args=None, cfg=None, VisionTransformerModule=VisionTransformer):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, args=args, cfg=cfg, VisionTransformerModule=VisionTransformerModule)
...
if __name__ == '__main__':
    # m = vit_base_patch16_224(pretrained=True, args=None, VisionTransformerModule=VT)
    # print(m)
    m = vit_small_patch16_224(VisionTransformerModule=VT)
    print(m)
    print('done')